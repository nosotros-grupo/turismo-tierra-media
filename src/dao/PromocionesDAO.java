...
public class PromocionesDAO {
	...
	private static PromocionAbsoluta toPromocionAbsoluta(ResultSet resultados, List<Atraccion> listaAtracciones) throws SQLException {
	...
	private static PromocionPorcentual toPromocionPorcentual(ResultSet resultados, List<Atraccion> listaAtracciones) throws SQLException {
		ArrayList<Atraccion> atracciones = new ArrayList<Atraccion>();
	...
	private static PromocionAxB toPromocionAxB(ResultSet resultados, List<Atraccion> listaAtracciones) throws SQLException {
		ArrayList<Atraccion> atraccionesPagas = new ArrayList<Atraccion>();
		String atraccionesPagasAsString = resultados.getString(2);
		for (Atraccion i:listaAtracciones) {
